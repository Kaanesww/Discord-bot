...
export const data = new SlashCommandBuilder()
  ...
  .addStringOption((o) =>
    o.setName("kullanici_id").setDescription("Yasağı kaldırılacak kullanıcının ID'si").setRequired(true),
  )
...
export async function execute(interaction: ChatInputCommandInteraction): Promise<void> {
  ...
  try {
    ...
    await interaction.editReply("❌ Bu ID ile yasaklı bir kullanıcı bulunamadı.");
    return;
  }
