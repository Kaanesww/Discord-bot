...
export const guardSettingsTable = pgTable("guard_settings", {
  ...
  botActions:      text("bot_actions").notNull().default("[]"),
  ...
  emojiActions:    text("emoji_actions").notNull().default("[]"),
  roleEnabled:     boolean("role_enabled").notNull().default(false),
  roleThreshold:   integer("role_threshold").notNull().default(5),
  roleActions:     text("role_actions").notNull().default("[]"),
  channelEnabled:  boolean("channel_enabled").notNull().default(false),
  channelThreshold: integer("channel_threshold").notNull().default(4),
  channelActions:  text("channel_actions").notNull().default("[]"),
  actionWindowSeconds: integer("action_window_seconds").notNull().default(10),
